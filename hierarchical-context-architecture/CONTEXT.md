...
- [references/templates.md](./references/templates.md): `CLAUDE.md` / `CONTEXT.md` / `AGENTS.md` 템플릿과 `.context-audit.yml` 예시
- [scripts/verify_context_tree.py](./scripts/verify_context_tree.py): 링크·경로·구조·운영 규칙 검증 스크립트
...
- 운영 기능은 `--strict`와 `.context-audit.yml` 자동 로드를 기준선으로 유지하기.
...
- `python3 hierarchical-context-architecture/scripts/verify_context_tree.py --root . --strict`
