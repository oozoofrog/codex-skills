---
name: jev-decision
description: Delegate a bounded implementation-plan, scope, next-step, or already-installed-skill choice to Jev. Do not use for advice-only review or execution authorization.
---
# Jev 개발 의사결정
