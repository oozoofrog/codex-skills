---
name: jev-triage
description: Classify bug reports and reported impact with Jev while keeping symptoms separate from confirmed causes. Do not automatically publish or assign issues.
---
# Jev 버그 분류
...
- `issue-triage`: `../jev-workbench/references/issue-triage.md`
