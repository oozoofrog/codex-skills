...
- `gptpro` schema-3 보안 경계 강화: structure validator가 candidate Python을 실행하지 않고, 참조된 Tunnel secret 환경 변수를 Git child에 전달하지 않으며, 새 handoff/archive를 각각 0700/0600으로 생성하고 Plugin starter prompt를 공식 배열·길이 규격으로 검증
