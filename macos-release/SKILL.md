...
name: macos-release
description: >-
  Automate or guide macOS release work for both GUI apps and CLI tools.
  Use when requests mention release, deploy, version bump, dry-run,
  DMG/ZIP packaging, local install verification, GitHub Release, Homebrew
  Cask or Formula, release workflow, CI/CD, GitHub Actions, brew-only
  updates, or publishing a new macOS version.
---
