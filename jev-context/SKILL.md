---
name: jev-context
description: Rank retrieved development context or select an existing source value with Jev. Preserve mandatory documents and never invent paths or quotations.
---
# Jev 자료·값 선택
...
- `context-rank`: `../jev-workbench/references/context-rank.md`
- `candidate-extract`: `../jev-workbench/references/candidate-extract.md`
