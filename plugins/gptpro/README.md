...
This directory packages the top-level [`gptpro`](../../gptpro/) Skill as a skills-only Codex Plugin, including its optional dependency-free macOS ChatGPT Desktop CDP runtime.
