...
6. Perform exactly one approved transport:
   ...
   - `paste`: paste the complete `paste_payload_path` content into the message composer. Do not attach a file. Any approved supplement is already embedded as a labeled, hashed text snapshot.
