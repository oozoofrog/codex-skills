...
1. 요청을 모드와 도메인으로 분류하기.
2. 필요한 reference만 선택해서 읽기.
3. 리뷰나 마이그레이션은 최소 변경과 버전 제약을 먼저 확인하기.
4. 결과에는 근거, 영향, 수정 방향, 검증 방법을 포함하기.
...
- 실전 규칙: `references/swift-practices-reference.md`, `references/swift-conventions-reference.md`
