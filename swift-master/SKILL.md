...
- SourceKit-LSP / code intelligence: `references/sourcekit-lsp.md`
...
### SourceKit-LSP / Code Intelligence

다음을 우선 점검하기.
- `sourcekit-lsp` 존재 여부
- `xcode-select` 와 toolchain 경로
- SwiftPM root / Xcode project context
- build 자체가 실패하는지, editor/LSP만 실패하는지

필요 시 `references/sourcekit-lsp.md`를 읽기.
