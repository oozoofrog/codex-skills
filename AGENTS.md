...
- Keep gptpro Plugin `interface.defaultPrompt` to 1–3 entries, each at most 128 characters and containing `$gptpro`, as enforced by `scripts/tests/test_plugin_distribution.py`.
