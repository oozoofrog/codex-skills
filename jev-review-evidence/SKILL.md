---
name: jev-review-evidence
description: Use Jev for bounded quality signals, claim-to-evidence checks, and additional test prioritization. Never replace actual builds, tests, or required checks.
---
# Jev 리뷰·검증 보조
...
- `review-signal`: `../jev-workbench/references/review-signal.md`
- `evidence-check`: `../jev-workbench/references/evidence-check.md`
- `test-priority`: `../jev-workbench/references/test-priority.md`
