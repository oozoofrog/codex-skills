...
대상 사용자의 명시적 목표·선호와 우선순위, 실제 후보, 이미 확보된 관찰/조사, 알려지지 않은 영향. 여러 제품 가치가 충돌하면 [프로젝트 적합성](project-fit.md)을 먼저 적용한다.

## 실행 절차

1. 사용자의 기준이 없거나 상충하는 선호의 우선순위가 선택을 바꿀 수 있으면 임의로 추정하지 않고 기준을 먼저 확보한다.
...
- 제품 전략·가격·개인정보와 편의성의 절충을 한 번의 문구 Choice로 정하지 않는다.
